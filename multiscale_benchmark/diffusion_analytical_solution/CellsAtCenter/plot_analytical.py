...
def main() -> None:
    ...
    parser.add_argument("--rate", type=float, default=1.6e-15, help="Uptake rate [mol/min].")
    ...
    sol = AnalyticalSolution( c_0=c_0, D=D, L=L, rate=rate, x_cells=x_cells, count_modes=count_modes )
